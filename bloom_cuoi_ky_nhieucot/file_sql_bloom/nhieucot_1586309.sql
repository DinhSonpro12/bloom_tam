...
create index idx_bloom on nhieucot_1586309 using bloom (c1,c2,c3);
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_1586309 where c1 = 929624263 and c2 = 2788872789 and c3 = 132803466;
