...
create index idx_bloom on nhieucot_2554766 using bloom (c1,c2,c3);
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_2554766 where c1 = 716262134 and c2 = 2148786402 and c3 = 102323162;
