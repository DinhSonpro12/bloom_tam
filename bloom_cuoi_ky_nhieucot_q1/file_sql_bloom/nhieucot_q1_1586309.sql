...
create index idx_bloom on nhieucot_q1_1586309 using bloom (c1,c2,c3);
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_q1_1586309 where c1 = 930916768;
