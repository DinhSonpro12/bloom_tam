...
create index idx_bloom on nhieucot_q1_285311 using bloom (c1,c2,c3);
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_q1_285311 where c1 = 91014656;
