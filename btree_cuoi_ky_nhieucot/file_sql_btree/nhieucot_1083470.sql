...
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_1083470 where c1 = 210905940 and c2 = 316358910 and c3 = 35150990;
create index idx_btree on nhieucot_1083470 (c1);
