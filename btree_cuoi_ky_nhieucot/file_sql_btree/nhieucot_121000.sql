...
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_121000 where c1 = 1264714826 and c2 = 1897072239 and c3 = 210785804;
create index idx_btree on nhieucot_121000 (c1);
