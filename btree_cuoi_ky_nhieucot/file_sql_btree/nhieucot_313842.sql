...
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_313842 where c1 = 1405184982 and c2 = 2107777473 and c3 = 234197497;
create index idx_btree on nhieucot_313842 (c1);
