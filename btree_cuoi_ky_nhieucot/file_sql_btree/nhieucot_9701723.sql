...
explain (analyze,verbose,timing,costs,buffers) select * from nhieucot_9701723 where c1 = 1659267176 and c2 = 2488900764 and c3 = 276544529;
create index idx_btree on nhieucot_9701723 (c1);
