...
loai = 'nhieucot'
sohang = sys.argv[1]
filename = 'file_sql_btree/' + loai + '_'+sohang + '.sql'
...
with open(filename,'w') as f:
    ...
    f.writelines(f'explain (analyze,verbose,timing,costs,buffers) select * from {tablename} where c1 = {random_number*2} and c2 = {random_number*3} and c3 = {random_number//3};')
    f.writelines('\n')
